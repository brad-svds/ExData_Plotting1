...
par(mfrow = c(2,2))
plot(specific_power$DateTime, specific_power$Global_active_power, type="l", xlab="",
     ylab = "Global Active Power")

plot(specific_power$DateTime, specific_power$Voltage, type="l", xlab="datetime",
     ylab = "Voltage")
...
plot(specific_power$DateTime, specific_power$Global_reactive_power, type="l", xlab="datetime",
     ylab = "Global_reactive_power")

dev.print(png, width = 480, height = 480, file = "plot4.png")
dev.off()